...
The agent equivalent of `crawl tour`, run by hand inside a coding agent. Drop this file into `.claude/skills/codebase-tour/SKILL.md` (Claude Code) or paste into a Cursor rule.
