...
# The mermaid script below is pinned to an exact version with an SRI hash and
# crossorigin, matching crawl/core/render.py; see coderay-q2r.19.
...
<script>
  // Disable auto-run synchronously so our loop controls rendering (as git-history does).
