...
- **Port source of record:** `~/code/Crack-Any-Codebase-with-AI`, branch `feat/unified-cli`, commit `5fd2a96`. Referred to below as `$SIB`. Verify with `git -C ~/code/Crack-Any-Codebase-with-AI rev-parse feat/unified-cli` before copying anything; it must print `5fd2a96585d27ad7fe2cd7d2c5f0d7941f15ee22`.
...
Expected: `wrote tests/fixtures/golden/backend/index.html and .../index.md from ... @ 5fd2a96`. The HTML should be 244 lines and the markdown 59.
